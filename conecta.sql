...
-- Tiempo de generación: 19-06-2026 a las 20:44:57
...
DROP TABLE IF EXISTS `categoria_skill`;
...
(5, 'Telecentro', 'Tele cable', 'S.A', '28-87654321-8', 'Comunicaciones', 'Argentina', 'Buenos Aires', 'Avellaneda', 1870, 'Belgrano', 1234, 1, 'A', 'rrhh@telecentro.com.ar', 'www.telecentro.com', '011-2222-3333', 'Mariano sanchez', 'telecentro2026');
...
(3, 2, 'Asistente de Base de Datos Tra', 'Prueba para soporte de scripts en SQL Server y documentación...', 'Híbrido', 'Trainee', '2026-06-09 18:18:00', 8);
...
DROP TABLE IF EXISTS `oferta_skill`;
...
DROP TABLE IF EXISTS `perfil_postulante`;
...
(1, 'Juan Pablo', 'Perez Perez', 10000000, 10000, 'Analista de Sistema', '10000000@itbeltran.com.ar', '87654321'),
...
(9, 'Maria Mercedes', 'Marin', 45333232, 1234, 'IA', '30222333@ibeltran.com.ar', 'Juan1234');
...
--
ALTER TABLE `postulante`
  MODIFY `id_postulante` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `ofertas`
  ADD CONSTRAINT `ofertas_ibfk_1` FOREIGN KEY (`id_empresa`) REFERENCES `empresa` (`id_empresa`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Filtros para la tabla `perfil_postulante`
--
ALTER TABLE `perfil_postulante`
  ADD CONSTRAINT `perfil_postulante_ibfk_1` FOREIGN KEY (`id_postulante`) REFERENCES `postulante` (`id_postulante`) ON DELETE CASCADE;
